...
(function() {
	...
	// Container: container08.
		new videoBackground('container08', {
			target: '#container08',
			src: 'assets/videos/container08.mp4',
			poster: 'assets/videos/container08.mp4.jpg',
			position: 'center',
			loop: true
		});
	
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.instance-5', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-15', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-35', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-17', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-18', { style: 'fade-right', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.instance-1', { style: 'fade-up', speed: 1000, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.text-component.instance-13', { style: 'fade-right', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
